        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Some service</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Would you like to update Our Work..</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
            ...
            <input type="hidden" name="id" value="<?php echo $result['id']?>">  
                ...
                <td><a href="someserviceupdate.php?id=<?php echo $result['id'];?>"><button type="button" class="btn  btn-primary">Update</button></a></td> 
            </tr>
...
<?php
  ...
  if(isset($_POST['update1'])){
      ...
      $query = "UPDATE someservice SET image1 = '$image1' ";
...
<?php
  ...
  if(isset($_POST['update2'])){
      ...
      $query = "UPDATE someservice SET image2 = '$image2' ";
        $fire = mysqli_query($con, $query) or die("can not fetch the data.".mysqli_error($con));
...
// include "dbcon.php";
  ...
  if(isset($_POST['update3'])){
      ...
      $query = "UPDATE someservice SET image3 = '$image3' ";
        $fire = mysqli_query($con, $query) or die("can not fetch the data.".mysqli_error($con));
...
// include "dbcon.php";
  ...
  if(isset($_POST['update4'])){
      ...
      $query = "UPDATE someservice SET image4 = '$image4' ";
        $fire = mysqli_query($con, $query) or die("can not fetch the data.".mysqli_error($con));
