...
<?php $thisPage="gallaryupdate.php"; ?>
	    	    ...
	    	    <div class="col-sm-6">
	          	...
	          	<div class="col-sm-6">
	            	<ol class="breadcrumb float-sm-right">
	              		...
	              		<li class="breadcrumb-item active">Gallary content Manage</li>
	            	</ol>
	          	</div>
	        </div>
	    </div><!-- /.container-fluid -->
...
<?php
  ...
  if(isset($_POST['update'])){
  	  ...
  	  $query ="UPDATE gallary SET h1 = '$h1', h2 = '$h2', h3 = '$h3', h4 = '$h4', h5 = '$h5', h6 = '$h6', h7 = '$h7', h8 = '$h8', h9 = '$h9', h10 = '$h10', h11 = '$h11', h12 = '$h12', h13 = '$h13' where id=$id";
  	  $fire = mysqli_query($con, $query) or die("can not fetch the data.".mysqli_error($con));
