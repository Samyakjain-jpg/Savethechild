      ...
      <div class="row">
          <div class="col-12">
            ...
            <input type="hidden" name="id" value="<?php echo $result['id']?>">  
                ...
                <td><a href="ourworkupdate.php?id=<?php echo $result['id'];?>"><button type="button" class="btn  btn-primary">Update</button></a></td> 
            </tr>
...
<?php
  ...
  if(isset($_POST['update1'])){
      ...
      $query = "UPDATE ourwork SET image1 = '$image1' ";
...
<?php
  ...
  if(isset($_POST['update2'])){
      ...
      $query = "UPDATE ourwork SET image2 = '$image2' ";
        $fire = mysqli_query($con, $query) or die("can not fetch the data.".mysqli_error($con));
...
// include "dbcon.php";
  ...
  if(isset($_POST['update3'])){
      ...
      $query = "UPDATE ourwork SET image3 = '$image3' ";
        $fire = mysqli_query($con, $query) or die("can not fetch the data.".mysqli_error($con));
...
// include "dbcon.php";
  ...
  if(isset($_POST['update4'])){
      ...
      $query = "UPDATE ourwork SET image4 = '$image4' ";
        $fire = mysqli_query($con, $query) or die("can not fetch the data.".mysqli_error($con));
