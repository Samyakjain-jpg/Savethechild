...
{
$id =$_GET['id'];
$query ="select * From someservice where id=$id";
...
<?php $thisPage="someserviceupdate.php"; ?>
	    	    ...
	    	    <div class="col-sm-6">
	          	...
	          	<div class="col-sm-6">
	            	<ol class="breadcrumb float-sm-right">
	              		...
	              		<li class="breadcrumb-item active">Some Services content Manage</li>
	            	</ol>
	          	</div>
	        </div>
	    </div><!-- /.container-fluid -->
		        	    ...
		        	    <div class="card-header">
		              	...
		              	<form role="form" method="post" action="" enctype="multipart/form-data"> 
		                	<div class="card-body">
			                  	...
			                  	<div class="form-group">
			                    	<label>Title12</label>
			                    	<input type="text" class="form-control" id="exampleInputPassword1" name="h12" value="<?php echo $user['h12'] ?>">
			                  	</div>
			                  	<div class="form-group">
			                    	<label>Title13</label>
			                    	<input type="text" class="form-control" id="exampleInputPassword1" name="h13" value="<?php echo $user['h13'] ?>">
			                  	</div>
			            	</div>
		                	<!-- /.card-body -->
...
<?php
  ...
  if(isset($_POST['update'])){
  	  ...
  	  $query ="UPDATE someservice SET h1 = '$h1', h2 = '$h2', h3 = '$h3', h4 = '$h4', h5 = '$h5', h6 = '$h6', h7 = '$h7', h8 = '$h8', h9 = '$h9', h10 = '$h10', h11 = '$h11', h12 = '$h12', h13 = '$h13' where id=$id";
  	  $fire = mysqli_query($con, $query) or die("can not fetch the data.".mysqli_error($con));
