...
<?php $thisPage="contactupload.php"; ?>
	    	    ...
	    	    <div class="col-sm-6">
	          	...
	          	<div class="col-sm-6">
	            	<ol class="breadcrumb float-sm-right">
	              		...
	              		<li class="breadcrumb-item active">Contact content Manage</li>
	            	</ol>
	          	</div>
	        </div>
	    </div><!-- /.container-fluid -->
		        ...
		        <div class="col-md-8">
		            ...
		            <div class="card card-primary">
		        	    <div class="card-header">
		                	<h3 class="card-title">Update Content Contact</h3>
		              	</div>
		              	<!-- /.card-header -->
		              	<!-- form start -->
...
<?php
  ...
  if(isset($_POST['update'])){
  	  ...
  	  $query ="UPDATE contact SET h1 = '$h1', h2 = '$h2', h3 = '$h3', h4 = '$h4', h5 = '$h5', h6 = '$h6', h7 = '$h7',h8 = '$h8' where id=$id";
  	  $fire = mysqli_query($con, $query) or die("can not fetch the data.".mysqli_error($con));
